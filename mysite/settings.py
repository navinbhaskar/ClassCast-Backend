...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'mysite.course_data',
    'mysite.generate_access_code',
    'mysite.gym_updated',
    'mysite.student_performance',
    'mysite.teachers',
    'mysite.teachers_app',
    'mysite.test',
    'mysite.test_updated',
    ...
    'mysite.device_id',
    'mysite.challenge',
    'mysite.key_generator',
    'mysite.license_provider',
    'mysite.white_label'
]
...
if os.getenv('GAE_APPLICATION', None):
    ...
    DATABASES = {
        'default': {
            ...
            'HOST': '/cloudsql/classcast-198812:us-central1:polls-instance',
            'USER': 'Pikachu',
            'PASSWORD': '123Pikachu#',
            'NAME': 'polls',
        }
